...
def render_app():
    template_names = 'data_prefixes data_projects data_flickr models_list models_create models_single models_slice process_thumbnail process_delete process_garbage process_exif process_modify process_copy annotate_list annotate_class visualize_thumbnails visualize_metadata visualize_exif visualize_locations visualize_times visualize_annotations evaluate_classifier'.split()
