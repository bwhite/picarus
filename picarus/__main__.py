...
def _main():
    ...
    sp.set_defaults(func=picarus.vision.run_image_feature)
    ...
    sp.set_defaults(func=picarus.classify.run_classifier_labels)
    ...
    sp.set_defaults(func=picarus.classify.run_train_classifier)
    ...
    sp.add_argument('hdfs_output', **ca['output'])
    sp.add_argument('hdfs_input', nargs='+', **ca['input'])
    sp.set_defaults(func=picarus.classify.run_predict_classifier)
    ...
    sp.set_defaults(func=picarus.classify.run_join_predictions)
    ...
    sp.set_defaults(func=picarus.vision.run_face_finder)

    # Whiten Features
    sp = sps.add_parser('whiten', help='Scale features to zero mean unit variance')
    sp.add_argument('hdfs_input', **ca['input'])
    sp.add_argument('hdfs_output', **ca['output'])
    sp.set_defaults(func=picarus.cluster.run_whiten)
    ...
    sp.set_defaults(func=picarus.cluster.run_sample)
    ...
    sp.set_defaults(func=picarus.cluster.run_kmeans)
    ...
    sp.add_argument('hdfs_output', **ca['output'])
    sp.add_argument('--metric', **ca['metric'])
    sp.set_defaults(func=picarus.cluster.run_hac)
    ...
    sp.set_defaults(func=picarus.vision.run_video_keyframe)
    ...
    sp.set_defaults(func=picarus.report.report_categories)
    ...
    sp.set_defaults(func=picarus.report.report_clusters)
    ...
    sp.set_defaults(func=picarus.report.report_video_keyframe)

    # Local Thumbnail Output
    sp = sps.add_parser('report_thumbnails', help='Report Categories from Face Clustering')
    sp.add_argument('hdfs_input', **ca['input'])
    sp.add_argument('local_thumb_output', help='local thumbnail output directory')
    sp.set_defaults(func=picarus.report.report_thumbnails)
