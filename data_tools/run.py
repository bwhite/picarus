...
tags = 'flowers flower love letter book hedgehog puppy garden house italy rome paris reno nevada florida birthday christmas turtledove tree snowflake airplane pen curly hair pretty sunset hiking washington capitol maryland'.split()
...
def mine_tags(tag_iter, num_iters=1):
    for x, y in enumerate(chunks(tags, 3)):
...
#tag_iter += 1
metadata_path = mine_tags(tag_iter, num_iters=10)
metadata_paths.append(metadata_path)
