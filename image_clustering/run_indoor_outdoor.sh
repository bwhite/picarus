...
python cluster.py join_predictions /user/brandyn/tp/image_classify/run-${RUN}/predict /user/brandyn/tp/image_classify/run-${RUN}/predict_join /user/brandyn/indoors /user/brandyn/outdoors --local_image_output classifier_predictions